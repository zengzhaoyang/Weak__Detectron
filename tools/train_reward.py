...
from modeling.model_reward_builder import Generalized_RCNN
        ...
        for step in range(args.start_step, cfg.SOLVER.MAX_ITER):
            ...
            for inner_iter in range(args.iter_size):
                ...
                for key in input_data:
                    if key != 'roidb' and key != 'ori_data' and key != 'im_info': # roidb is a list of ndarrays with inconsistent length
