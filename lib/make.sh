...
/var/storage/shared/resrchvc/v-zhazen/anaconda3/bin/python3 setup.py build_ext --inplace
rm -rf build
...
cd ../
/var/storage/shared/resrchvc/v-zhazen/anaconda3/bin/python3 build.py
