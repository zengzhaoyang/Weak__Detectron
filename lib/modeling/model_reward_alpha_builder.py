...
import modeling.reward_alpha_heads as reward_heads
...
class Generalized_RCNN(nn.Module):
    ...
    def _forward(self, data, ori_data, superpixels, im_info, rois, labels_int32, alpha):
        ...
        if self.training:
            ...
            cls_loss, refine_loss1, refine_loss2, refine_loss3, bbox_loss = reward_heads.reward_losses(rois, ori_data, superpixels,  im_info, bbox_mul, labels_int32, cls_refine1, cls_refine2, cls_refine3, bbox_pred, alpha)
