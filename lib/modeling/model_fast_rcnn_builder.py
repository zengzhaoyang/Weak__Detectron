...
class Generalized_RCNN(nn.Module):
    def __init__(self):
        ...
        print('dim_out', self.Conv_Body.dim_out)
    ...
    def forward(self, data, im_info, roidb=None):
        if cfg.PYTORCH_VERSION_LESS_THAN_040:
            return self._forward(data, im_info, roidb)
        else:
    ...
    def _forward(self, data, im_info, roidb=None):
        ...
        if self.training:
            ...
            # Testing
            return_dict['rois'] = ssw_ret['rois']
            return_dict['cls_score'] = cls_score
            return_dict['bbox_pred'] = bbox_pred

        return return_dict

    def roi_feature_transform(self, blobs_in, ssw_ret, blob_rois='rois', method='RoIPoolF',
